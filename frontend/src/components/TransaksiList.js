...
const TransaksiList = () => {
    ...
    // const displayButton = () => {
    //     if (detail_transaksi.transaksi.dibayar === "belum_dibayar") {
    //         return (
    //             <td className="text-center">
    //             <Link to={`/transaksi/ubah/${detail_transaksi.id_transaksi}`} className="btn btn-primary mr-3">Ubah Status</Link>
    //             <Link to={`/transaksi/bayar/${utang.id_transaksi}`} className="btn btn-primary mr-3">Konfirmasi</Link>
    ...
    .map((detail_transaksi, index) => {
        return (
            <tr key={detail_transaksi.id_detail_transaksi}>
                ...
                { (detail_transaksi.transaksi.dibayar === "belum_dibayar") ? (<td className="text-center"> 
                <Link to={`/transaksi/ubah/${detail_transaksi.id_transaksi}`} className="btn btn-primary mr-3">Ubah Status</Link>
